                                        ...
                                        '<div class="row no-bottom">' +
                                            '<div class="col-xs-12">' +
                                                '<div class="form-group cool-form-group form-group-sm">' +
                                                    '<div class="cool-form-label text-right control-label">内容：</div>' +
                                                    '<textarea rows="4" class="form-control textarea" placeholder="输入内容500字以内" id="content" name="content"></textarea>' +
                                                '</div>' +
                                            '</div>' +
                                            '<div class="col-xs-12">' +
                                                '<div class="form-group cool-form-group form-group-sm">' +
