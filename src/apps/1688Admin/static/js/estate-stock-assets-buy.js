$(document).ready(function(){
    ...
    $btn_edit.click(function () {
        if(!$(this).attr('disabled')) {
            ...
            window.location.href='estate-stock-assets-buy-edit.html';
        }
    });
    ...
    $btn_preview.click(function () {
        if(!$(this).attr('disabled')) {
            ...
            window.location.href='estate-stock-assets-buy-view.html';
        }
    });
    ...
    $btn_cancel.click(function () {
        ...
        if(!$(this).attr('disabled')) {
            ...
            BSModal.confirm({ content: "确认要取消该条目的申请吗？" }).on(function (e) {
                if (!e) {
                    return;
                }
